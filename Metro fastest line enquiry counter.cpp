...
void forgot() {
    ...
    delay(90);
    gotoxy(47,8);
    printf("Press 1 to get password");
    system("color 0C");
    delay(90);
    system("color 0D");
    delay(90);
...
void logo(int x, int y)
{
   gotoxy(x,y);
    printf("                WELCOME               ");
    gotoxy(x,y+2);
    printf("             TO OUR METRO COUNTER      ");
    gotoxy(x,y+4);
    printf("         WE ARE HAPPY TO SEE YOU HERE    ");
}
...
void UI(){
    ...
    else printf("PLEASE PRESS ENTER");
    y++;
    char ch;
    scanf("%c",&ch);
    secondWindow();
